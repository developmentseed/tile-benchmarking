...
class Reader(BaseReader):
    ...
    def __attrs_post_init__(self):
        ...
        if not self.dataset:
            ...
            print(f"time in rasterio.open: {round(t.elapsed * 1000, 2)}")
            if dataset.gcps[0]:
                with Timer() as t:
                ...
                print(f"time in initiating WarpedVRT: {round(t.elapsed * 1000, 2)}")
            else:
    ...
    def part(
        ...
        **kwargs: Any,
        ...
        print(f"time in rasterio.io.reader#part: {round(t.elapsed * 1000, 2)}")
