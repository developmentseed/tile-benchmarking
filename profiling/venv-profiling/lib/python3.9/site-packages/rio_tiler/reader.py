...
def read(
    ...
    with contextlib.ExitStack() as ctx:
        ...
        if (dst_crs != src_dst.crs) or nodata is not None or vrt_options:
            ...
            print(f"time initiating WarpedVRT: {round(t.elapsed*1000, 2)}")
        else:
            dataset = src_dst
        ...
        if ColorInterp.alpha in dataset.colorinterp:
            ...
            print(f"time reading WarpedVRT: {round(t.elapsed*1000, 2)}")
        ...
        print(f"time creating ImageData: {round(t.elapsed*1000, 2)}")
